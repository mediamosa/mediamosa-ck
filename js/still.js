...
function media_mediamosa_still_hide_by_type(obj) {
	...
	switch ($(obj).val()) {
		case 'NONE':
			media_mediamosa_still_hideshow_item('show-media_mediamosa-still-time-code', true); // None.
		...
		case 'NORMAL':
			media_mediamosa_still_hideshow_item('show-media_mediamosa-still-time-code', false); // None.
